const addEventOnElem = function (e, t, a) {
    if (e.length > 1) for (let n = 0; n < e.length; n++) e[n].addEventListener(t, a);
...
window.addEventListener("scroll", function () {
    window.scrollY >= 100 ? (header.classList.add("active"), backTopBtn.classList.add("active")) : (header.classList.remove("active"), backTopBtn.classList.remove("active"));
});
    ...
    reviews = [
        {
            ...
            name: "Rabia Imsig",
            star: "⭐⭐⭐⭐⭐",
            review: "Cliente depuis des ann\xe9es et toujours aussi contente travaille impeccable tr\xe8s professionnelle irr\xe9prochable. Je recommande \xe0 100%100. Surtout pour un d\xe9tartrage tr\xe8s satisfaite.",
        },
        {
            id: 1,
            image: "/assets/images/male-icon.png",
            name: "Evaguelos Kireccioglu",
            star: "⭐⭐⭐⭐⭐",
            review:
        ...
        { id: 2, image: "/assets/images/woman-icon.png", name: "Doris Elkan", star: "⭐⭐⭐⭐⭐", review: "Excellent service et amabilit\xe9 sans pareil. Je recommande vivement pour tout ce qui concerne les proth\xe8ses dentaires." },
        {
            id: 3,
            image: "/assets/images/woman-icon.png",
            name: "Florence Deremiens",
            star: "⭐⭐⭐⭐⭐",
            review:
        ...
        { id: 6, image: "/assets/images/woman-icon.png", name: "Angeliki Bouras", star: "⭐⭐⭐⭐⭐", review: "Tr\xe8s bon  dentiste conventionn\xe9 ! Excellent proth\xe9siste sur place. Je recommande" },
        {
            id: 7,
            image: "/assets/images/woman-icon.png",
            name: "Teresa Santos",
            star: "⭐⭐⭐⭐⭐",
            review: "Toujours tr\xe8s content de votre travail je suis avec vous depuis des ann\xe9es et toujours tr\xe8s satisfait \uD83D\uDC4C\uD83C\uDFFD",
        },
        {
            id: 8,
            image: "/assets/images/male-icon.png",
            name: "Flow Tomoon",
            star: "⭐⭐⭐⭐⭐",
            review: "Accueil chaleureux  et conseils avis\xe9s ! Mr Jean est aux petits soins et \xe0 l \xe9coute ! Il prend son temps et c'est rare! Merci ! Je recommande vivement ce cabinet dentaire.",
        },
        { id: 9, image: "/assets/images/male-icon.png", name: "Gaetan Dartois", star: "⭐⭐⭐⭐⭐", review: "Quelle super service re\xe7u rapidement et efficace MERCI MERCI. A recommand\xe9 MILLE MERCIS ENCORE" },
    ];
let currentID = 0;
...
function updateDisplayInfo() {
    ...
    (el_image.src = e), (el_name.textContent = t), (el_stars.textContent = a), (el_review.textContent = n);
}
next_btn.addEventListener("click", nextReview), surprise_btn.addEventListener("click", randomReview);
